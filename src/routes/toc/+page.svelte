<script lang="ts">
  import TextJustify from "$lib/TextJustify.svelte";
  import Header from "$lib/Header.svelte";
</script>

<div class="xl:max-w-2xl mx-auto p-2 xl:py-2">
  <Header mt={false}>Terms & Conditions</Header>
  ...
  <TextJustify>
    Halim is committed to ensuring that the app is as useful and efficient as possible. For that
  ...
  <TextJustify>
    The Pocket QR app stores and processes personal data that you have provided to us, in order to
    provide our Service. It’s your responsibility to keep your phone and access to the app secure.
    ...
    your phone’s security features and it could mean that the Pocket QR app won’t work properly or
    at all.
  </TextJustify>
  ...
  <ul class="list-disc pl-4 pb-4">
    <li>
      <a class="text-accent" href="https://www.google.com/policies/privacy/">Google Play Services</a
      >
    </li>
    <li>
      <a class="text-accent" href="https://firebase.google.com/policies/analytics"
  ...
  <TextJustify>
    You should be aware that there are certain things that Halim will not take responsibility for.
    Certain functions of the app will require the app to have an active internet connection. The
    connection can be Wi-Fi, or provided by your mobile network provider, but Halim cannot take
  ...
  <TextJustify>
    Along the same lines, Halim cannot always take responsibility for the way you use the app i.e.
    You need to make sure that your device stays charged – if it runs out of battery and you can’t
    turn it on to avail the Service, Halim cannot accept responsibility.
  </TextJustify>

  <TextJustify>
    With respect to Halim’s responsibility for your use of the app, when you’re using the app, it’s
    important to bear in mind that although we endeavour to ensure that it is updated and correct at
    all times, we do rely on third parties to provide information to us so that we can make it
    available to you. Halim accepts no liability for any loss, direct or indirect, you experience as
  ...
  <TextJustify>
    ...
    app. Halim does not promise that it will always update the app so that it is relevant to you
    and/or works with the Android version that you have installed on your device. However, you
  ...
  <Header>Changes to This Terms and Conditions</Header>
  ...
  <TextJustify>These terms and conditions are effective as of 2023-03-03</TextJustify>

  <Header>Contact Us</Header>
  <TextJustify>
    If you have any questions or suggestions about our Terms and Conditions, do not hesitate to
    contact us at <a class="text-accent" href="mailto: dev@halim.dev">dev@halim.dev</a>.
  </TextJustify>
</div>
